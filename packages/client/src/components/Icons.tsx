...
// Every icon in this file is a 24×24 outline glyph from the same set, so the
// eight attributes that make it one live here instead of being repeated in each
// of them. `props` still spreads last, so a caller can override any of them —
// which is how `className` reaches the svg.
