...
> **दायरा:** यह मार्गदर्शिका **एकल इंस्टेंस, स्व-होस्ट** व्यवस्था को समेटती है, TLS के साथ या बिना (नीचे «HTTPS पर परोसना» देखें)। सार्वजनिक बहु-किरायेदार होस्टिंग और फ़ेडरेशन की मज़बूती v0.1 के दायरे से बाहर हैं — वास्तुशिल्पीय दिशा के लिए `docs/02-architecture.md` देखें।
...
|---------|--------------------|
| उन्नयन के बाद `postgres` बार-बार पुनःआरंभ होता है | उसका वॉल्यूम PostgreSQL 16 ने लिखा था। देखें «2026-08-29 से पहले बने इंस्टेंस का उन्नयन»। |
