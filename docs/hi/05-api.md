...
हैंडशेक पर जाँचा गया टोकन socket की ज़मानत हमेशा के लिए नहीं देता: access token की अवधि बीतते ही सर्वर `4001` कोड से कनेक्शन बंद कर देता है, और क्लाइंट दोबारा जुड़ने से पहले टोकन नवीनीकृत करता है। लॉगआउट, या refresh token का दोबारा इस्तेमाल पकड़ा जाना, जिस session को मिटाता है उसके तहत खुले socket `1008` कोड से बंद कर देता है।
...
| `/a2a/v1/*` | 60/मिनट प्रति IP और पथ, पूरे `/a2a/v1` पर 300/मिनट प्रति IP |
