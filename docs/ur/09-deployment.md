...
> **دائرہ:** یہ رہنما **واحد انسٹنس، خود میزبانی** والے بندوبست کو سمیٹتا ہے، TLS کے ساتھ یا بغیر (نیچے «HTTPS پر پیش کرنا» دیکھیں)۔ عوامی کثیر کرایہ دار میزبانی اور فیڈریشن کی سختی v0.1 کے دائرے سے باہر ہیں — تعمیراتی سمت کے لیے `docs/02-architecture.md` دیکھیں۔
...
| علامت | ممکنہ وجہ / حل |
|---------|--------------------|
| اپ گریڈ کے بعد `postgres` بار بار دوبارہ چلتا ہے | اس کا والیوم PostgreSQL 16 نے لکھا تھا۔ دیکھیں «2026-08-29 سے پہلے بنے انسٹنس کی اپ گریڈ»۔ |
