...
ہینڈ شیک پر جانچا گیا ٹوکن socket کی ضمانت ہمیشہ کے لیے نہیں دیتا: access token کی مدت ختم ہوتے ہی سرور `4001` کوڈ سے کنکشن بند کر دیتا ہے، اور کلائنٹ دوبارہ جڑنے سے پہلے ٹوکن تازہ کرتا ہے۔ لاگ آؤٹ، یا refresh token کا دوبارہ استعمال پکڑا جانا، جس سیشن کو مٹاتا ہے اس کے تحت کھلے socket `1008` کوڈ سے بند کر دیتا ہے۔
