...
> **অবস্থা (2026-09-01)**: এই নথিতে যা আছে তা লক্ষ্যরূপ। আজ সত্যিই যা আছে তা হলো **সার্ভার-প্রান্তের প্রকল্প-স্মৃতি** — MCP-এর `read_project_memory` / `write_project_memory` আপনার নিজের ইনস্ট্যান্সের `project_memory` টেবিলে `facts` / `decisions` রাখে (ব্যবহারকারী × প্রকল্প × peer অনুসারে অনন্য), রূপ এখনও Markdown। নিচের `.claude/` ফাইল-বিন্যাস, `confer.toml` বিশ্লেষণ ও স্বয়ংক্রিয় তথ্য-নিষ্কাশন এখনও বাস্তবায়িত হয়নি; অগ্রগতির জন্য [`08-mvp-backlog.md`](./08-mvp-backlog.md)-এর v0.2 দেখুন।
