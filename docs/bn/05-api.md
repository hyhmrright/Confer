...
হ্যান্ডশেকে যাচাই হওয়া টোকেন socket-এর হয়ে চিরকাল জামিন থাকে না: access token-এর মেয়াদ ফুরালে সার্ভার `4001` কোডে সংযোগ বন্ধ করে, আর ক্লায়েন্ট আবার যুক্ত হওয়ার আগে টোকেন নবায়ন করে। লগআউট, বা refresh token পুনর্ব্যবহার ধরা পড়া, যে সেশন মুছে দেয় তার অধীনে খোলা socket-গুলো `1008` কোডে বন্ধ করে।
...
| `/a2a/v1/*` | ৬০/মিনিট প্রতি IP ও পাথ, পুরো `/a2a/v1` জুড়ে ৩০০/মিনিট প্রতি IP |
