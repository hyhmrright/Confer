...
ولا يظلّ الرمز الذي فُحص عند المصافحة ضامنًا للمقبس إلى الأبد: فحين تنتهي صلاحية رمز الوصول يُغلق الخادم الاتصال بالرمز `4001`، فيجدّد العميل رمزه قبل أن يعيد الاتصال. وتسجيل الخروج، أو اكتشاف إعادة استخدام رمز التحديث، يُغلق بالرمز `1008` المقابسَ المفتوحة تحت الجلسة التي يحذفها.
...
| `/a2a/v1/*` | 60 في الدقيقة لكل عنوان IP ومسار، و300 في الدقيقة لكل عنوان IP على كامل `/a2a/v1` |
